    ...
    <>
      <div className="m-5">
        ...
        <div className="sm:grid sm:grid-cols-20 mt-16 sm:mt-44 sm:px-10">
          <div className="sm:col-span-12">
            ...
            <div className="text-start mt-5 sm:mt-8 text-gray-700 font-roboto sm:text-lg">
              At HummbleCare, we provide unparalleled care services for the
              elderly and disabled, ensuring they receive the attention and
              support they deserve. Our dedicated team is here to offer
              personalized care around the clock.
            </div>
        ...
        <div className=" bg-green-200 mt-16 -m-5 text-center p-10 ">
          ...
          <div className="mt-8 text-sm sm:text-lg">Our Services</div>
          <div className="mt-5 text-sm sm:text-lg">Support</div>
