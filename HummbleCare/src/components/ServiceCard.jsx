...
function ServiceCard({Icon, title, description, points}) {
    return <div>
        <div className="group border-2 border-green-200 hover:border-green-300 hover:scale-105 hover:shadow-2xl transition-all duration-300 rounded-2xl p-10">
            <div className="bg-gradient-to-br from-green-400 to-green-700 w-16 h-16 group-hover:scale-120 transition-all duration-300 p-4 rounded-2xl">
