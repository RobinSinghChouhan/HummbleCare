...
function RoundedIconBtn({IconLabel, label}) {
  return (
    <div className="group border border-green-700 flex shadow-2xl justify-center rounded-4xl px-4 sm:px-7 transition-all py-1 sm:py-3 bg-green-600  hover:cursor-pointer hover:bg-green-700 w-full items-center">
